...
The current stable version is: [2.5.2](../../releases/tag/2.5.2).
...
```
pip3 install --process-dependency-links git+https://github.com/answear/kube-vcloud-flexvolume.git@2.5.2
```
