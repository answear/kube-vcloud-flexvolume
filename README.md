...
The current works-for-me version is: [1.2.1b1](../../releases/tag/1.2.1b1).
...
```
pip install --process-dependency-links git+https://github.com/sysoperator/kube-vcloud-flexvolume.git@1.2.1b1
```
