...
The current Release Candidate is: [2.2.2rc1](../../releases/tag/2.2.2rc1).
...
```
pip3 install --process-dependency-links git+https://github.com/sysoperator/kube-vcloud-flexvolume.git@2.2.2rc1
```
