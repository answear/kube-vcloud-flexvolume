...
The current stable version is: [2.4.1](../../releases/tag/2.4.1).
...
```
pip3 install --process-dependency-links git+https://github.com/answear/kube-vcloud-flexvolume.git@2.4.1
```
